    ...
    <div className="most-followed-chefs max-w-[1200px] mb-12 lg:mb-18 mx-auto">
      ...
      <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 lg:mt-12 ">
        {chefs.map((chef, index) => (
          <li key={index} className="bg-gray-100 rounded-md overflow-hidden h-24 max-w-96 gap-6">
            <div className="p-4">
              <img src={chef.avatar} alt={chef.name} className=" object-cover rounded-t-lg" />
              <div className="p-4">
